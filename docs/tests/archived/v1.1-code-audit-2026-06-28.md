...
| 86 | SumUp error handling UI | Laptop / Desktop | 1. Simulate checkout failure (network block on createCheckout API). | Error panel with retry, copy reference, WhatsApp support link. | — |
