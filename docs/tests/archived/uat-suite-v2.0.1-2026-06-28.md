...
| **Command** | `yarn test:e2e` — 55 tests, all passing |
| **Automated cases** | 53 ✅ Pass in Status column below |
| **Pending** | Manual / device-only cases — update Status when executed |
...
| **Legacy** | Cross-reference to v1.0 PDF ID and/or v1.1 numeric ID |

**Automated regression:** `yarn start` then `yarn test:e2e` (55 Playwright tests in [`tests/`](../../../tests/)).
...
| NAV-02 | Brand logo returns home | Mobile – Portrait | 1. Open any inner page. 2. Tap logo. | Returns to homepage. | Medium | Manual | MD-2 | Pending |
...
| NAV-04 | Sticky navbar on scroll | Mobile – Portrait | 1. Accept cookies. 2. Scroll 500px+. 3. Observe nav. | Navbar stays fixed; logo and menu control remain visible. | Medium | Manual | N-01 | Pending |
...
| NAV-06 | Hamburger closes with close control | Mobile – Portrait | 1. Open menu. 2. Tap × (close). | Menu collapses; backdrop removed. | Medium | Manual | N-02 | Pending |
...
| NAV-08 | Nav behaviour in landscape | Mobile – Landscape | 1. Load at 844×390. 2. Observe nav mode. | Menu usable; no overflow or clipped labels (may show expanded or hamburger per width). | Medium | Manual | N-03, R-04 | Pending |
...
| NAV-14 | Salah times nav dropdown (desktop) | Laptop / Desktop | 1. Click Salah times in nav. | Right-aligned panel; Hijri date; sunrise; full timetable and PDF links. | Medium | Manual | N-08 | Pending |
| NAV-15 | Salah times PDF in nav | Laptop / Desktop | 1. Open dropdown. 2. Click monthly PDF. | PDF opens/downloads from Cloud Run URL. | Medium | Manual | MD-10 | Pending |
| NAV-16 | Donate now in navbar | All devices | 1. Tap/click Donate now. | GoFundMe donate opens in new tab (`rel="noopener"`). | High | Manual | MD-11, N-09 | Pending |
| NAV-17 | Active page indicated in nav | Laptop / Desktop | 1. Open `contact.html`. 2. Observe About nav parent. | Current section visually active (`.active` or equivalent). | Medium | Manual | N-10 | Pending |
| NAV-18 | Skip to main content | Laptop / Desktop | 1. Tab as first action. 2. Activate skip link. | Focus jumps to `#main-content`, bypassing nav. | High | Manual | N-11, ACC-01 | Pending |
...
| NAV-20 | Footer links on all pages | Laptop / Desktop | 1. Visit all 7 main pages. 2. Scroll to footer. | Prayer times, programmes, contact, database link, social links, copyright year current. | Medium | Manual | MD-12 | Pending |
| NAV-21 | Floating dock — WhatsApp | Mobile – Portrait | 1. Tap WhatsApp in dock. | Opens `wa.me`; no ↗ icon on dock button. | Medium | Manual | MD-13 | Pending |
| NAV-22 | Floating dock — Donate | Mobile – Portrait | 1. Tap Donate in dock. | Opens GoFundMe donate. | Medium | Manual | MD-14 | Pending |
| NAV-23 | Back to top | Mobile – Portrait | 1. Scroll deep on `projects.html`. 2. Tap back-to-top. | Smooth scroll to top after threshold. | Low | Manual | MD-15 | Pending |
...
| CC-04 | Cookie settings panel | Mobile – Portrait | 1. Tap Cookie settings on banner. | Preferences dialog with toggles; Strictly Necessary always on. | High | Manual | CC-04 | Pending |
| CC-05 | Functional cache toggle | Laptop / Desktop | 1. Disable Functional. 2. Reload prayer times. | Optional cache cleared; fresh fetch attempted. | Medium | Manual | MD-22 | Pending |
...
| CC-09 | No banner on return visit | Mobile – Portrait | 1. Accept all. 2. Close browser. 3. Reopen site. | Banner does not reappear. | Medium | Manual | CC-07 | Pending |
| CC-10 | Privacy & cookies footer link | Mobile – Portrait | 1. Footer → Privacy & cookies. | Preferences dialog opens. | Medium | Manual | CC-08 | Pending |
...
| ANN-04 | Daily hadith on inner pages | Mobile – Portrait | 1. Open `about.html`; scroll to hadith. | Text, narrator, source link from API or fallback. | Low | Manual | MD-32 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| HOME-01 | Hero renders (mobile) | Mobile – Portrait | 1. Accept cookies. 2. View above-the-fold. | Hero readable; no overflow; CTAs tappable without zoom. | Medium | Manual | H-01 | Pending |
...
| HOME-11 | Pillars of Islam accordion | Mobile – Portrait | 1. Tap each of 5 pillars. | Expands/collapses; readable on small screen. | Medium | Manual | MD-41 | Pending |
...
| HOME-13 | Explore hub links | Mobile – Portrait | 1. Tap each Explore card. | Correct destinations (prayer times, programmes, madrasa, contact, projects). | Medium | Manual | MD-43 | Pending |
...
| HOME-19 | Qur'an verse block | Laptop / Desktop | 1. Scroll to Qur'an section. | Arabic + translation; quran.com link works. | Low | Manual | MD-49 | Pending |
...
| HOME-21 | Very small screen (320px) | Mobile – Portrait | 1. Load at 320px width. | No horizontal scroll; text readable without zoom. | Medium | Manual | H-07, R-02 | Pending |
| HOME-22 | Footer copyright year | Laptop / Desktop | 1. Scroll to footer. | © year matches current year via `#footer-year`. | Low | Manual | H-06 | Pending |
...
| PT-07 | Print timetable | Laptop / Desktop | 1. Click Print timetable. | Print dialog; branded print sheet. | Medium | Manual | MD-57 | Pending |
...
| PT-16 | Hijri date display | All devices | 1. Load prayer-times page. | Hijri date shown and plausible for today. | Medium | Manual | PT-06 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| ACT-01 | This week schedule | All devices | 1. Open `activities.html#this-week`. | Weekly grid from API; today/tomorrow highlighted. | High | `homepage.spec.js` | MD-66, A-01 | ✅ Pass |
...
| ACT-03 | Programme details modal | Mobile – Portrait | 1. Tap interactive programme. | Modal with details; `aria-modal`; Esc closes. | High | `homepage.spec.js` | MD-68 | ✅ Pass |
| ACT-04 | Programme guide — adults | Laptop / Desktop | 1. Open Programme guide. | Adult programmes with rhythm copy. | Medium | Manual | MD-69, A-02 | Pending |
| ACT-05 | Programme guide — madrasa card | Mobile – Portrait | 1. Find madrasa card. | Links to `madrasa.html`; not labelled as database enrolment. | Medium | Manual | MD-70 | Pending |
| ACT-06 | Women's weekly class | All devices | 1. Navigate to `#womens-weekly-class`. | Schedule, location, contact shown. | Medium | Manual | A-03 | Pending |
...
| ACT-08 | Mixlr behind consent gate | All devices | 1. Decline third-party embeds. 2. Open Live audio. | Consent placeholder, not iframe. | High | Manual | MD-71, A-05 | Pending |
...
| ACT-11 | How to join CTAs | Mobile – Portrait | 1. Follow How to join links. | Correct destinations. | Medium | Manual | MD-74 | Pending |
...
| ACT-13 | External links open new tab | Laptop / Desktop | 1. Click Mixlr archive, database, app links. | `target="_blank"`; site not navigated away. | Medium | Manual | A-06 | Pending |
...
| PROJ-03 | Two parts one vision badges | Mobile – Portrait | 1. Read centre vs masjid cards. | In Progress and Planned badges. | Low | Manual | MD-78 | ✅ Pass |
...
| PROJ-07 | Funding breakdown | Laptop / Desktop | 1. Read What your donation supports. | Amounts and labels correct (€122k, €150k, etc.). | Medium | Manual | MD-82 | ✅ Pass |
| PROJ-08 | Bank details toggle | Mobile – Portrait | 1. Expand bank transfer details. | IBAN revealed; collapses again. | Medium | Manual | MD-83 | Pending |
...
| PROJ-11 | SumUp error handling | Laptop / Desktop | 1. Block createCheckout API. | Error panel with retry, reference, WhatsApp. | Medium | Manual | MD-86 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| ABOUT-01 | Hero stats animation | Laptop / Desktop | 1. Load `about.html`. | Stats animate (1988, 2001, 140+, CHY 14981). | Low | Manual | MD-89 | Pending |
| ABOUT-02 | Timeline and story | Mobile – Portrait | 1. Scroll story sections. | Photos load; readable text. | Medium | Manual | MD-90, AB-02 | Pending |
| ABOUT-03 | Team member cards | Mobile – Portrait | 1. View Our team. | Photos, names, alt text. | Medium | Manual | MD-91, AB-01 | Pending |
| ABOUT-04 | Visit and Connect cards | Laptop / Desktop | 1. Tap maps, contact, programmes cards. | Correct destinations. | Medium | Manual | MD-92 | Pending |
| ABOUT-05 | Support GoFundMe bar | Mobile – Portrait | 1. Scroll Support section. | Progress bar; donate works. | Low | Manual | MD-93 | Pending |
| ABOUT-06 | Section nav scroll-spy | Mobile – Portrait | 1. Use sticky nav across sections. | Active section updates. | Medium | Manual | MD-94, AB-03 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| MAD-01 | Hero WhatsApp CTA | Mobile – Portrait | 1. Tap Register on WhatsApp in hero. | WhatsApp with enrolment message. | Medium | Manual | MD-95 | Pending |
| MAD-02 | Class times tables | Mobile – Portrait | 1. Scroll to Class times. | Boys/girls schedules readable. | Medium | Manual | MD-96, M-01 | Pending |
| MAD-03 | Ready to enrol band | Mobile – Portrait | 1. Tap `#ready-to-enrol` CTA. | WhatsApp only — not Microsoft Form. | High | Manual | MD-97, M-03 | Pending |
| MAD-04 | Life With Allah app links | Laptop / Desktop | 1. Tap store links in adhkar section. | Correct App Store / Play URLs. | Low | Manual | MD-98 | Pending |
| MAD-05 | Enrolment copy plain language | Mobile – Portrait | 1. Read enrolment steps. | WhatsApp-only enrolment clear; no jargon. | Medium | Manual | MD-99 | Pending |
| MAD-06 | Madrasa layout mobile / landscape | Mobile – Landscape | 1. View class times in landscape. | Tables usable; nav not overlapping. | Low | Manual | MD-100, M-02 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| CONT-01 | Contact form visible | Mobile – Portrait | 1. Open `contact.html` → Send a message. | Name, Email, Message with labels and submit. | High | Manual | MD-101, CF-01 | Pending |
...
| CONT-07 | Imam call buttons | Mobile – Portrait | 1. Tap Call on imam card. | `tel:` opens dialler. | High | Manual | MD-101, CF-08 | Pending |
| CONT-08 | WhatsApp buttons | Mobile – Portrait | 1. Tap WhatsApp on contact page. | WhatsApp with greeting message. | High | Manual | CF-09 | Pending |
...
| CONT-12 | Contact section nav | Mobile – Portrait | 1. Tap each section nav item. | Smooth scroll; active link updates. | Medium | Manual | MD-107, CF-14 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| RESP-01 | No horizontal scroll sitewide | Mobile – Portrait | 1. Each page at 375px. | No page-level horizontal scrollbar. | High | Manual | R-01 | Pending |
| RESP-02 | Text readable without zoom | Mobile – Portrait | 1. Homepage without pinch-zoom. | Body ≥16px equivalent; headings clear. | High | Manual | R-02 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| SEO-01 | Unique page titles | Laptop / Desktop | 1. Open all 7 main pages. | Unique descriptive `<title>` each. | Medium | Manual | MD-128 | Pending |
| SEO-02 | Canonical URLs | Laptop / Desktop | 1. View canonical on 2+ pages. | `https://traleemasjidkicc.ie/...` | Medium | Manual | MD-129, SEO-01 | Pending |
| SEO-03 | Open Graph / Twitter cards | Laptop / Desktop | 1. Inspect meta tags. | og:title, description, image per page. | Low | Manual | MD-130, SEO-02 | Pending |
...
| SEO-05 | sitemap.xml | Laptop / Desktop | 1. Open `/sitemap.xml`. | All public HTML pages listed. | Medium | Manual | MD-131, SEO-04 | Pending |
| SEO-06 | robots.txt | Laptop / Desktop | 1. Open `/robots.txt`. | Allows crawl; references sitemap. | Low | Manual | SEO-05 | Pending |
...
| # | Test Case Heading | Device / Orientation | How to Test (Steps) | Expected Result | Priority | Automation | Legacy | Status |
|---|-------------------|----------------------|----------------------|-----------------|----------|------------|--------|--------|
| ERR-01 | Branded 404 page | Laptop / Desktop | 1. Visit nonexistent path on production. | Branded `404.html` with nav and helpful links. | High | Manual | MD-136, E-01 | ✅ Pass |
| ERR-02 | Invalid hash anchor | Mobile – Portrait | 1. Open `about.html#nonexistent`. | Page loads; no JS crash. | Low | Manual | MD-137 | Pending |
| ERR-03 | Prayer API total failure | Mobile – Portrait | 1. Block Cloud Run; clear cache. | Nav panel degrades; no infinite spinners. | Medium | Manual | MD-138, E-02 | Pending |
| ERR-04 | Mixlr API failure | Laptop / Desktop | 1. Block api.mixlr.com. | Off air / fallback; page usable. | Medium | Manual | MD-139 | Pending |
...
| ERR-06 | Maps consent placeholder copy | Mobile – Portrait | 1. Decline embeds; open contact map. | Styled placeholder with Privacy & cookies link — not blank. | Medium | Manual | E-04 | Pending |
...
### Execution summary (28 June 2026)

| Metric | Count |
|--------|-------|
| **Total test cases** | **100** |
| ✅ Pass (automated or verified) | 53 |
| Pending (manual / device) | 46 |
| N/A | 1 |
...
- **Payment completion:** SumUp end-to-end charge (PROJ-11) — sandbox/test card required
